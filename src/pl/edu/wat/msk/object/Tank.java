...
public class Tank extends BaseObject {
    ...
    private boolean wystrzeleniePocisku;
    ...
    public boolean isWystrzeleniePocisku() {
        return wystrzeleniePocisku;
    }

    public void setWystrzeleniePocisku(boolean wystrzeleniePocisku) {
        this.wystrzeleniePocisku = wystrzeleniePocisku;
    }
}
